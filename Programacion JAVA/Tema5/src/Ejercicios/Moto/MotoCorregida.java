...
public class MotoCorregida {
    ...
    //constructor
    public MotoCorregida(String matricula, String marca, int plazas, String modelo, int potencia, int velocidad_max, double capacidad_deposito) {
